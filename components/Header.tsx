  ...
  return (
    <div className="max-w-6xl mx-auto p-2">
      ...
      <section className="flex items-center space-x-2 py-5">
        ...
        <div className="flex items-center sm:space-x-2 md:px-5 py-2 border-black border-2 flex-1 px-1">
          <MagnifyingGlassIcon className="w-5 text-gray-400" />
          <input
            type="text"
            placeholder="Search for Anything"
            className="flex-1 outline-none text-xs sm:text-sm md:text-md"
          />
        </div>
        ...
        <Link href="/create">
          <button className="text-sm md:text-md h-11 border-2 border-blue-600 px-5 md:px-10  md-py-2 text-blue-600 hover:bg-blue-600/50 hover:text-white cursor-pointer">
            List Item
          </button>
        </Link>
      </section>
